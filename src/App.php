...
class App{
    ...
    */
    public static function login(){
        ...
        if(isset($_POST['username'])){
            ...
            $query = "SELECT u.*, un.grupo FROM usuario as u LEFT JOIN usuarios_nestle as un ON (TRIM(un.cedula) = TRIM(u.cedula)) WHERE u.cedula = :cedula";
    ...
    *
    */
    public static function saveResult($usuario, $modulo, $puntaje, $intento, $tipo, $tiempo){
        $db = Database::getDB();
        $data = [
            'usuario_id' => $usuario,
            'modulo_id' => $modulo,
    ...
    *
    */
    public static function getPreguntas($modulo, $tipo){
        $db = Database::getDB();
        
        $queryPreguntas = "SELECT id as element, numero as id, tipo, texto as pregunta, respuesta_correcta, puntos FROM pregunta WHERE modulo_id = :modulo_id AND modulo_tipo = :modulo_tipo";
        ...
        foreach($setPreguntas as $k => $v){
            $queryRespuestas = "SELECT numero as id, texto FROM respuesta WHERE pregunta_id = :pregunta_id";
