...
<div class="nav-menu" id="nav-menu">
    <ul>
        ...
        <li class="nav-links"><a href="<?= $site['base_url'] ?>/puntaje/" class="">Mi puntaje</a></li>
        <li class="nav-links"><a href="<?= $site['base_url'] ?>/perfil/" class="">Mi perfil</a></li>
        <li class="nav-links"><a href="<?= $site['base_url'] ?>/logout/" class="">Salir</a></li>
    </ul>
